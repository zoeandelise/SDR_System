...
/**
 * 食物分类表 diet_food_category
 * 
 * @author SDR_System
 */
public class DietFoodCategory extends BaseEntity
{
    ...
    @Size(min = 0, max = 20, message = "负责人不能超过20个字符")
    ...
    @Size(min = 0, max = 11, message = "联系电话不能超过11个字符")
    ...
    @Size(min = 0, max = 50, message = "邮箱不能超过50个字符")
