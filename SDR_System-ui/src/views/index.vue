  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>基于协同过滤的个性化健康饮食推荐系统</h2>
        <p>
          本系统运用协同过滤算法，结合用户健康数据（BMI、BMR、慢性病史）和饮食偏好，
          为用户提供科学、个性化的健康饮食推荐方案。系统基于《中国居民膳食指南2024》和
          《中国食物成分表2024》，确保推荐的营养合理性和健康安全性。
        </p>
        ...
        <p>
          ...
          <el-tag type="primary" style="margin-left: 10px;">营养分析</el-tag>
          <el-tag type="warning" style="margin-left: 10px;">健康管理</el-tag>
        </p>
        <div style="margin-top: 30px; padding: 20px; background: #f5f7fa; border-radius: 8px;">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <div style="text-align: center; padding: 15px;">
                <div style="font-size: 32px; color: #409EFF; font-weight: bold;">160</div>
                <div style="color: #666; margin-top: 5px;">注册用户</div>
              </div>
            </el-col>
            <el-col :span="12">
              <div style="text-align: center; padding: 15px;">
                <div style="font-size: 32px; color: #67C23A; font-weight: bold;">55</div>
                <div style="color: #666; margin-top: 5px;">食物种类</div>
              </div>
            </el-col>
          </el-row>
          <el-row :gutter="20" style="margin-top: 10px;">
            <el-col :span="12">
              <div style="text-align: center; padding: 15px;">
                <div style="font-size: 32px; color: #E6A23C; font-weight: bold;">68</div>
                <div style="color: #666; margin-top: 5px;">推荐记录</div>
              </div>
            </el-col>
            <el-col :span="12">
              <div style="text-align: center; padding: 15px;">
                <div style="font-size: 32px; color: #F56C6C; font-weight: bold;">100%</div>
                <div style="color: #666; margin-top: 5px;">数据真实性</div>
              </div>
            </el-col>
          </el-row>
        </div>
      ...
      <el-col :sm="24" :lg="12" style="padding-left: 50px">
        ...
        <el-row style="margin-top: 20px;">
          <el-col :span="24">
            <div style="padding: 15px; border-left: 4px solid #409EFF; background: #ecf5ff; margin-bottom: 15px;">
              <h4 style="margin: 0 0 10px 0; color: #409EFF;">
                <i class="el-icon-cpu"></i> 智能推荐算法
              </h4>
              <p style="margin: 0; color: #666; font-size: 14px;">
                基于BMR/BMI的精准营养匹配，营养达标优先（70%权重），历史反馈学习优化
              </p>
            </div>
            
            <div style="padding: 15px; border-left: 4px solid #67C23A; background: #f0f9ff; margin-bottom: 15px;">
              <h4 style="margin: 0 0 10px 0; color: #67C23A;">
                <i class="el-icon-document-checked"></i> 健康规则过滤
              </h4>
              <p style="margin: 0; color: #666; font-size: 14px;">
                糖尿病（GI值<55）、高血压（钠<300mg）、痛风（嘌呤<50mg）、高血脂（胆固醇<100mg）
              </p>
            </div>
            
            <div style="padding: 15px; border-left: 4px solid #E6A23C; background: #fdf6ec; margin-bottom: 15px;">
              <h4 style="margin: 0 0 10px 0; color: #E6A23C;">
                <i class="el-icon-pie-chart"></i> 营养数据完整
              </h4>
              <p style="margin: 0; color: #666; font-size: 14px;">
                55种食物100%营养数据，参考《中国食物成分表2024》权威标准
              </p>
            </div>
            
            <div style="padding: 15px; border-left: 4px solid #F56C6C; background: #fef0f0;">
              <h4 style="margin: 0 0 10px 0; color: #F56C6C;">
                <i class="el-icon-data-analysis"></i> 多样性优化
              </h4>
              <p style="margin: 0; color: #666; font-size: 14px;">
                近期推荐惩罚机制，确保推荐多样性，推荐重复率≤10%
              </p>
            </div>
          </el-col>
        </el-row>
        ...
        <el-row style="margin-top: 30px;">
          <el-col :span="24">
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
              ...
              <el-tag size="small">Python ML</el-tag>
